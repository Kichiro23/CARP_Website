          ...
          <div className="glass-strong p-6 sm:p-8">
            ...
            <div className="mb-5 text-center">
              ...
              <p className="mt-1 text-xs" style={{ color: 'var(--text-secondary)' }}>
                Join the global climate research community
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              >
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {showDropdown && (
                    <div
                      className="absolute left-0 right-0 top-full z-20 mt-2 max-h-56 overflow-auto rounded-xl border shadow-2xl"
                      style={{
                    ...
                    >
                      <div
                        className="sticky top-0 flex gap-1 p-2"
                        style={{
                          background: 'var(--bg-secondary)',
                      ...
                      >
                        {getPhRegions().map((r) => (
                          <button
                            ...
                            style={{
                              background: regionFilter === r ? 'var(--primary)' : 'transparent',
                        ...
                        filteredCities.map((city) => (
                          ...
                          >
                            <div
                              ...
                              style={{ background: 'rgba(234,157,99,0.1)' }}
                            >
                            ...
                            <div className="min-w-0 overflow-hidden">
                              ...
                              <p className="text-[10px] truncate" style={{ color: 'var(--text-muted)' }}>
                                {city.province} &middot; {city.region}
                              </p>
                            </div>
                          </button>
                        ))
                ...
                {selectedCity && (
                  <div
                    ...
                    style={{
                      background: 'rgba(234,157,99,0.08)',
                      border: '1px solid rgba(234,157,99,0.2)',
                    }}
                  >
              ...
              <button
                type="submit"
                className="glass-btn w-full flex items-center justify-center gap-2 py-3 text-sm font-bold"
              >
